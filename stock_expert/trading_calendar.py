...
USER_CONFIRMED_MARKET_HOLIDAYS = {
    # Exact exchange-closed dates confirmed by the user; religious holidays
    # must not be modeled as recurring month/day rules.
    date(2026, 5, 1),
    date(2026, 5, 19),
    date(2026, 5, 27),
    date(2026, 5, 28),
...
def is_trading_session(day: date) -> bool:
    return day.weekday() < 5 and day not in USER_CONFIRMED_MARKET_HOLIDAYS
