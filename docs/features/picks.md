...
- `routine` reports normal persisted picks, score-ranked vs bucketed review comparison, plus a no-chase-penalty dry-run comparison after the live CSV import
