...
- GitHub CI runs the standard-library Python test suite and the frontend test/build gates for pull requests into `main` and pushes to `main`; deployment remains separate until a hosting target is selected.
